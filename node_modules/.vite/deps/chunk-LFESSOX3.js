...
var TouchRipple = React11.forwardRef(function TouchRipple2(props, ref) {
  ...
  var startCommit = React11.useCallback(function(params) {
    ...
    setRipples(function(oldRipples) {
      return [].concat(_toConsumableArray(oldRipples), [React11.createElement(Ripple_default, {
        key: nextKey.current,
        classes,
        timeout: DURATION,
        pulsate: pulsate2,
  ...
  return React11.createElement("span", _extends({
    ...
    ref: container
  }, other), React11.createElement(TransitionGroup_default, {
    component: null,
    exit: true
  }, ripples));
});
...
var ButtonBase = React12.forwardRef(function ButtonBase2(props, ref) {
  ...
  return React12.createElement(ComponentProp, _extends({
    ...
    React12.createElement(TouchRipple_default, _extends({
      ref: rippleRef,
      center: centerRipple
    }, TouchRippleProps))
  ) : null);
...
//# sourceMappingURL=chunk-LFESSOX3.js.map
